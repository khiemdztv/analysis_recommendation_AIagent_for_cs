...
Bài báo gốc của nhóm nghiên cứu MIT/Harvard tập trung phân tích khả năng của AI (expert-rated) và mong muốn tự động hóa ở hai khía cạnh:
1.  **Coi lực lượng lao động là một "khối đồng nhất" (Homogeneous Group):** 
    - *Ý nghĩa:* Bài báo mặc định toàn bộ người lao động trong cùng một ngành nghề phản ứng giống hệt nhau với AI, không phân biệt tuổi tác, giới tính, học vấn hay kinh nghiệm.
    - *Ví dụ:* Họ coi tất cả "Lập trình viên" (Computer Programmers) là như nhau. Họ bỏ qua sự thật rằng một sinh viên nam 22 tuổi mới tốt nghiệp sẽ có thái độ, kỹ năng sử dụng và nỗi lo mất việc (Job Security) rất khác so với một lập trình viên nữ 50 tuổi đã có 25 năm kinh nghiệm.
2.  **Chỉ phân tích ở "cấp độ tác vụ chung" (Task-level analysis):**
    - *Ý nghĩa:* Đánh giá khả năng và mong muốn tự động hóa chỉ dựa trên mô tả công việc của tác vụ đó, bỏ qua cảm xúc, sở thích và trải nghiệm thực tế của người trực tiếp thực hiện nó.
    - *Ví dụ:* Đối với tác vụ *"Viết code kiểm thử phần mềm (Unit Test)"*, bài báo gốc chỉ đánh giá chung chung: *"Tác vụ này AI làm tốt 4.0 điểm, người lao động muốn tự động hóa nó 3.0 điểm"*. Họ bỏ qua thực tế rằng nếu một lập trình viên vô cùng ghét việc viết test (Enjoyment = 1), họ sẽ muốn tự động hóa nó tối đa (Desire = 5). Ngược lại, nếu họ chưa từng sử dụng ChatGPT (LLM Familiarity thấp), họ sẽ phản đối tự động hóa vì sợ mất việc.
